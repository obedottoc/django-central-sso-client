...
class SSORequiredMiddleware(MiddlewareMixin):
    exempt_prefixes = ("/sso/", "/admin/","/healthz/","/static/","/iclock/","/secauth/","/devices/get-pending-bioids","/devices/post-biometric-templates","/devices/bio-sync-get-pending-bioids","/devices/bio-sync-update-status")
